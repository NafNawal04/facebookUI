...
const stories = [
  {
    id: '1',
    name: 'Create story',
    image: require('../../assets/images/create-story.jpg'), 
    isCreate: true,
  },
  {
    id: '2',
    name: 'Muhid Rahman',
    image: require('../../assets/images/muhid.jpg'), 
  },
  {
    id: '3',
    name: 'Niaz Rahman',
    image: require('../../assets/images/niaz.jpg'), 
  },
  {
    id: '4',
    name: 'Tashim E Ashraf',
    image: require('../../assets/images/tashim.jpg'), 
  },
];
...
const posts = [
  {
    id: '1',
    user: {
      name: 'Cultural Classicists',
      avatar: require('../../assets/images/post-1-dp.jpg'), 
      time: '1h',
    },
    text: 'More details in the comment...',
  ...
  },
  {
    ...
    user: {
      name: 'Selzuk',
      avatar: require('../../assets/images/post-2-dp.jpg'), 
      time: 'Sponsored',
    },
    text: 'এতগুলো আইটেম পাচ্ছেন মাত্র ১১৫০ টাকায়...',
  ...
  },
  {
    ...
    user: {
      name: 'Classic',
      avatar: require('../../assets/images/post-3-dp.jpg'), 
      time: '2h',
    },
    text: 'I have dedicated my research work to these people who have been with me since (see more)...',
